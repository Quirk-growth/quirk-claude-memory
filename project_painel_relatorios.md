...
- **AINDA STUB:** `criativos[]` e `sociais[]` nos adapters retornam [] (Meta level=ad + IG insights não implementados) → seções "Principais criativos" e "Seguidores" ficam vazias até completar. Google dormente (MCC vazia).
