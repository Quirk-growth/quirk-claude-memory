...
metadata: 
  ...
  modified: 2026-07-29T14:30:29.332Z
---
...
**Bug (jul/2026, investigado a fundo):** reuniões da rota do Renan pararam de entrar na agenda `contato@quirkgrowth.com.br` desde ~15/mai/2026. Causa REAL provada com teste ao vivo: a conexão Make **"Quirk Growth" (id 3645550)** está autenticada na **conta Google ERRADA** (provavelmente renan.reeal@gmail.com, dono do Make) — a metadata dela ainda MOSTRA "contato@quirkgrowth.com.br" mas está desatualizada; eventos criados por ela caem em outra agenda. Por isso `calendar: contato@quirkgrowth.com.br` dá **[404] Not Found**, mas `calendar: primary` funciona.
