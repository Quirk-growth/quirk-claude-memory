...
**Gotchas desta entrega:** push do Drizzle TRAVA (>10min) no banco de teste inchado quando há coleção nova — pré-criar as tabelas no teste com a mesma DDL destrava · setContent do puppeteer-core 25.9 não aceita networkidle0, usar 'load' + document.fonts.ready · custo por proposta ~R$ 0,50-2 (sonnet-5, ~30k tokens saída).
