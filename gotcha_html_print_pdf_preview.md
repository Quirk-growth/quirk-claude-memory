...
metadata: 
  ...
  modified: 2026-09-04T15:12:10.778Z
---

Armadilhas do pipeline HTML → PDF com Chrome headless (decks, papelaria, manuais):

0. **Chrome headless zumbi trava o batch inteiro** — uma instância presa faz as invocações seguintes pendurarem sem erro (o comando nunca retorna). Fix: `pkill -f "Google Chrome.*--headless"` antes de rodar sequência longa de exports; rodar o pipeline em etapas com timeout, não num comando só.
