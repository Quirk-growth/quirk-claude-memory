---
name: m-dia-kit-renan-chaiene-podcasts
description: "Mídia kit em PDF pra pauta de podcasts — fonte em ~/midia-kit-quirk/, copy aprovada e regras do Renan"
metadata: 
  node_type: memory
  type: project
...
**Números Quirk aprovados:** +100 clientes · 26 especialistas · 6 anos de mercado · presença em +17 estados.
**Métricas IG (30 dias, ago/2026):** Renan @renanrealoficial 32.075 seguidores (+16,4%), 5,4 mi views, +4.519 novos; Chaiene 14.337 (+101,8%), 7,9 mi views, +7.234 novos. Somados ~13 mi views/mês.

**Assets:** fotos profissionais do Renan = `Downloads/CSX_2848.jpg` (terno azul) e `CSX_2876.jpg` (terno preto); foto da Chaiene extraída do GPA (pág. mentores). Prints de métricas vieram do Drive (pasta 1ZcUZ9CWGGfZXpUAFzCcgK_BW7woAt0py, baixáveis via `curl uc?export=download&id=`). Pendências: @ da Chaiene e WhatsApp na pág. de contato (placeholders).
